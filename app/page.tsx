...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="px-4 py-6 lg:py-12 lg:px-20">
        <div className="space-y-6 lg:space-y-12 max-w-4xl mx-auto lg:max-w-7xl">
          <div
            ref={(el) => {
          ...
          <div className="space-y-4 mb-12 lg:justify-center lg:items-center lg:flex lg:gap-20 lg:flex-row-reverse">
            <div
              ref={(el) => {
            ...
            <div className="rounded-lg">
              ...
              <div className="flex flex-wrap gap-3 justify-center">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`bg-[#441A05] text-white px-5 py-2 lg:px-10 lg:py-4 rounded-full text-sm lg:text-xl font-semibold hover:bg-white hover:text-[#441A05] hover:ring-2 hover:ring-[#441A05] transition-all duration-300 inline-flex items-center gap-2`}
                >
                  <svg
                ...
                <a
                  href="/files/Plans and Programs - Diocesan Year of Sacramental Life .pdf"
                  download
                  className={`bg-white text-[#441A05] px-5 py-2 lg:px-10 lg:py-4 rounded-full text-sm lg:text-xl font-semibold ring-2 ring-[#441A05] hover:bg-[#441A05] hover:text-white transition-all duration-300 inline-flex items-center gap-2 `}
                >
                  <svg
                    className="w-4 h-4 lg:w-5 lg:h-5"
                    fill="none"
