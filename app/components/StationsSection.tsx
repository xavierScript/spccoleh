    ...
    <section className="mb-12">
      <div className="mb-4">
        ...
        <a
          ...
          className={`inline-block bg-[#441A05] text-white px-5 py-2 lg:px-6 lg:py-3 rounded-full text-sm lg:text-base font-semibold hover:bg-white hover:text-[#441A05] hover:ring-2 hover:ring-[#441A05] transition-all duration-300 ${
